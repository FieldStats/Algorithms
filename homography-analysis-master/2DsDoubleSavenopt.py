...
OUTPUT_LEFT_VIDEO = "transformed_left_output.mp4"
OUTPUT_RIGHT_VIDEO = "transformed_right_output.mp4"
...
def filter_objects(objects):
    """
    Filter out objects with colors 'purple' or 'orange'.
    """
    return [obj for obj in objects if obj.get("color") not in ["purple", "orange"]]
...
def process_video(video_file, json_intersection, json_non_intersection, homography_matrix, output_file, frame_width, frame_height):
    ...
    while frame_index < total_frames:
        ...
        if frame_data_intersection:
            ...
            transformed_frame = draw_objects_as_dots_with_ids(transformed_frame, filtered_objects, homography_matrix)
